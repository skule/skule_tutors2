...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field taught_courses on 'Tutor'
        db.create_table('tutors_tutor_taught_courses', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('tutor', models.ForeignKey(orm['tutors.tutor'], null=False)),
            ('course', models.ForeignKey(orm['course_manage.course'], null=False))
        ))
        db.create_unique('tutors_tutor_taught_courses', ['tutor_id', 'course_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field taught_courses on 'Tutor'
        db.delete_table('tutors_tutor_taught_courses')
    ...
    models = {
        ...
        'tutors.tutor': {
            ...
            'auth': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['auth.User']", 'unique': 'True', 'null': 'True'}),
            ...
            'taught_courses': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['course_manage.Course']", 'null': 'True', 'symmetrical': 'False'})
        }
    }
